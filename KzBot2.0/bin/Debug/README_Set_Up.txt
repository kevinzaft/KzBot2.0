...
NEW: 	-added buttons to "reset" default screenshots RECOMMENED TO DO SO BEFORE RUNNING BOT
	-added config file (KzBot2.exe.config) so users can customize stuff (change the "value" in the "key"s to what you want)
